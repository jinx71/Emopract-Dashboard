...
const TopSideButtons = () => {
    ...
    const openAddNewLeadModal = () => {
        dispatch(openModal({title : "Add New Client", bodyType : MODAL_BODY_TYPES.LEAD_ADD_NEW}))
    }
...
function Leads(){
    ...
    return(
        <>
            ...
            <TitleCard title="Current Clients" topMargin="mt-2" TopSideButtons={<TopSideButtons />}>
